    ...
    <div className="min-h-screen bg-slate-950">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-10 lg:grid-cols-2">
          {/* Dark Elegant Form */}
          <div>
            <h2 className="mb-4 text-xl font-bold text-white">Dark Elegant</h2>
          ...
          {/* Glassmorphism Form */}
          <div>
            <h2 className="mb-4 text-xl font-bold text-white">Glassmorphism Form</h2>
          ...
          {/* Multi-step Form */}
          <div>
            <h2 className="mb-4 text-xl font-bold text-white">Multi-Step Progress</h2>
            <div className="rounded-2xl border border-slate-800 bg-slate-900 p-8">
              {/* Steps indicator */}
              <div className="flex items-center justify-between">
          ...
          <div className="lg:col-span-2">
            <h2 className="mb-4 text-xl font-bold text-white">Search & Filter</h2>
